/**
 * Kinetic Type theme manifest — the registry entry point, exposing tokens
 * and components only. styles.css is deliberately NOT imported here:
 * Astro bundles any CSS reachable through the registry's dynamic-import
 * glob into every page (all themes stacked, cascade collisions). The page
